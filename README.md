...
| 기본형 데이터와 참조형 데이터 | [불변값][불변값]                                 |            8            |    [Santos][santos]     |                       |
|                               | [가변값][가변값]                                 |           10            |    [Santos][santos]     |                       |
|                               | [변수 복사 비교][변수복사비교]                        |           15            |    [Santos][santos]     |                       |
| 불변 객체                     | [불변 객체를 만드는 간단한 방법][불변객체를만드는간단한방법]         |           20            |    [Santos][santos]     |                       |
|                               | [얕은 복사와 깊은 복사][얕은복사와깊은복사]                   |           25            |    [Santos][santos]     |                       |
| undefined와 null              | [undefined와 null][undefined와null]                       |           29            |    [Santos][santos]     |                       |
| 정리                          | [정리][데이터타입정리]                                   |           34            |    [Santos][santos]     |                       |
...
[데이터타입정리]: ./contents/01.데이터타입/7.정리/7-1.정리.md